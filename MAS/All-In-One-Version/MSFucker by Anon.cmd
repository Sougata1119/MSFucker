...
::::
::  For command line switches, check sougata[.]dev/command_line_switches.html
...
::
::   Homepage: sougata.dev
::      Email: contact@sougata.dev
::
::============================================================================
...
echo:             Fuck You Microsoft Activation Script by Sougata(Anon) 
echo:             
echo:             Status:
...
::  5th column = Ticket signature value. It's as it is, it's not encoded. (Check sougata[.]dev/hwid.html#Manual_Activation to see how it's generated)
...
::  sougata[.]dev/office-license-is-not-genuine.html
...
::
::  For any further question, feel free to contact us on sougata[.]dev/contactus
::
::========================================================================================================================================
...
::  Check  sougata[.]dev/kms38.html#Manual_Activation to see how it's generated
...
if not [%Act_OK%]==[1] (
echo.
echo In case of any issues, check https://sougata.dev/troubleshoot
)
...
echo:   
echo   Homepage: sougata[.]dev
echo      Email: contact@sougata.dev
)>"%_dest%\Info.txt"
exit /b
